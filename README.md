...
| Modelo              |Notebook| Parametros | Epochs | Train Accuracy | Val Accuracy | Test Accuracy | Train F1 | Val F1 | Test F1 |
|---------------------|----|-----------|--------|----------------|--------------|---------------|---------|---------|---------|
| Modelo Simple       | modelo_1 |196612     | 1000   | 0.99           | 0.79         | 0.80          | 0.99    | 0.79    | 0.80    |
| Random Forest       | modelo_2 |47844      | -      | 1              | 0.73         | 0.71          | 1       | 0.76    |  0.75   |
| CNN Básica          | modelo_3 |516        | 140    | 0.47| 0.483         | 0.462          | 0.467    | 0.48    | 0.62    |
| CNN 2xConv16        | modelo_2_simple |2836       | 110     |0.51            | 0.51         | 0.523         | 0.48    | 0.48    | 0.49    |
| CNN 3xConv16        | modelo_3_simple |5156       | 160     | 0.762          | 0.749        | 0.718         | 0.745   | 0.735   | 0.698   |
| CNN 3xConv16+Dense16| modelo_4_simple |5428       | 160    | 0.880          | 0.866        | 0.859         | 0.877   | 0.860   | 0.854   |
| CNN Conv32 + 2xConv16 + Dense16 | modelo_5_simple |8.180    | 160    | 0.742          |0.737        | 0.718         | 0.726   | 0.724   | 0.703   |
| CNN 2xConv32 + Conv16 + Dense 16 | modelo_6_simple |15108 | 100 | 0.811|  0.815 | 0.808| 0.793 |  0.798 | 0.789 |
| VGG(Frozzen) + Dense512 + Dense256 | modelo_vgg |15109700 | 70 | 0.866 | 0.850 | 0.853 | 0.865 | 0.847 | 0.850 |
| VGG + Dense512 + Dense256 | modelo_vgg_2 |15109700 |  40 | 0.999 | 0.906 | 0.914 | 0.999 | 0.906 | 0.913 |
| VGG(Block4) + Dense512 + Dense256 | modelo_vgg_3 |8030276 | 40 | 0.999 | 0.906  |0.914 | 0.999 | 0.906 | 0.913 |
| VGG(Block3) + Dense512 + Dense256 | modelo_vgg_4 |1999428 | 40 | 0.998 | 0.915 | 0.927 | 0.998 | 0.914 | 0.926 |
| VGG(Block2) + Dense512 + Dense256 | modelo_vgg_5 |458,564 | 40 | 0.261 | 0.255| 0.236|0.108 |0.103|0.09|
